EPDERtI_Mb-9fVgy9u3nlSIKmWeLQpZZzCeh_VoIPqj4zoFU54DsT1lJBXNxZmOr6jAQms4EfPGme5ve-j-KnaWpKiztFhBuOVDT-Loywgm1-Yg6xQh5KndEh6b27DuWfN-58Kp6_AeEECsDL-M0HcLgSGf0JstNMgBG_8zYPjXa8Jq6mDPr35_P8GDgk6jjR2WuenCQl_r70LA4-4HAUNJh_UJHwmqX2hzUFGEczf6IeWDaG-JXpya0i8ZBnS8_pPMLtMqYJsJSdrxG98rzXJmy3MH0ue3zZXPPnhIyP2kZmMK1a1gwMAw7xZyZp954lsW2LxY-ajeUC_wXqlY1yieBy0piQoEN7ariTHe6t0ow5T6MHOe2mw-lebj8-h8VmxN7_o9aMd7AsBevfbkEka9tdLV5wP7I9IbqtZnpAenT-qrdsbxxGDRv7fAAcNmd_bT6Iy3J_uWKhZpr0DIEey0T5DO0rUH5LWljxO8.WC2oUSTJbrxBQ6EjlgrartKtL_nqTGdT5XAD0_SQ6nY"
...
class XboxMarketplaceComparerV2:
    """V2 主程序類"""
    ...
    def run_incremental_update(self, browse_all: int = 0, multi_sort: int = 0, max_pages: int = None) -> bool:
        """
        執行增量更新或全量掃描流程
        ...
        """
        print("\n" + "=" * 60)
        print("🎮 Xbox 商店遊戲對比工具 V2")
        print("=" * 60)
        print(f"源地區：{SOURCE_LOCALE}")
        print(f"目標地區：{TARGET_LOCALE}")
        print(f"資料庫：{self.db_path}")
        print(f"掃描模式：{'全量驗證 (browse_all=1)' if browse_all else '增量更新 (browse_all=0)'}")
        ...
        if browse_all == 0:
            # 增量模式：只重檢 delisted/region-locked 的遊戲
            ...
            if not games_to_recheck:
                ...
                print(f"   需要重檢：{len(games_to_recheck)} 款 delisted/region-locked 遊戲")

                # 構建要檢查的遊戲字典
                games_dict = {}
                for game_id, product_id, ja_title in games_to_recheck:
                ...
                # 用配置的排序方式檢查
                result = self.scraper.check_target_games_with_multiple_sorts(
                    games_dict,
                    TARGET_LOCALE,
                    max_pages=max_pages,
                    multi_sort=bool(multi_sort)
                )
                target_games = result['games']
        else:
            # 全量模式：掃描所有遊戲在目標地區的狀態
            result = self.scraper.check_target_games_with_multiple_sorts(
                source_games,
    ...
    def recheck_delisted_games(self, max_pages: int = None) -> bool:
        ...
        # 批量檢查台灣狀態
        target_games = self.scraper.check_target_games(
            games_to_check,
            TARGET_LOCALE,
            max_pages=max_pages
        )
    ...
    def export_results(self, mode: str = "limited") -> bool:
        ...
        try:
            # 匯出 CSV
            self.db.export_csv(OUTPUT_CSV, mode=mode)
        ...
        try:
            ...
            reporter.generate_report(
                ...
                stats={
                    ...
                    'total': stats['available'] + stats['region-locked'] + stats['delisted'],
                },
    ...
    def run(self, browse_all: int = 0, multi_sort: int = 0, recheck_delisted: bool = False, max_pages: int = None):
        """
        執行完整流程
        ...
        try:
            ...
            if not self.run_incremental_update(browse_all=browse_all, multi_sort=multi_sort, max_pages=max_pages):
                sys.exit(1)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Xbox 商店遊戲對比工具 V2",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
使用範例：

  # 增量模式（推薦日常使用）
  python xbox_compare_v2.py --browse-all 0

  # 全量驗證模式（推薦週期性使用）
  python xbox_compare_v2.py --browse-all 1

  # 全量模式 + 自定義延遲
  python xbox_compare_v2.py --browse-all 1 --delay 2.0
...
詳細說明見 README.md
    ...
    # 執行
    comparer = XboxMarketplaceComparerV2(
